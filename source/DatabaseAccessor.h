...
class DatabaseAccessor 
{
   ...
   public:
      ...
      static void insertNewRecord(int id, string name, int hours, string lastLogTime, int isLoggedIn);
      static void printAllRecords();
      static vector<User *> *getUser(int id);
      static vector<User *> *getAllUsers();
      static void updateRecord(int id, int hours, string lastLogTime, int isLoggedIn);
